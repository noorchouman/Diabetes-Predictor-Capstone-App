// src/DiabetesInfo.jsx
import React from "react";
import { Link } from "react-router-dom";

const Section = ({ title, eyebrow, icon, children }) => (
  <section className="card p-6 md:p-7 space-y-3">
    <div className="flex items-start gap-3">
      {icon && (
        <div className="mt-1 h-9 w-9 flex-shrink-0 rounded-2xl bg-emerald-50 flex items-center justify-center text-lg">
          <span>{icon}</span>
        </div>
      )}
      ...
      <div className="max-w-5xl mx-auto px-5 pt-10 pb-16 space-y-8">
        ...
        <header className="relative overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-r from-emerald-50 via-white to-sky-50 px-6 py-7 md:px-8 md:py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-3 max-w-2xl">
            <p className="text-xs font-semibold tracking-wide uppercase text-emerald-700">
              Type 2 diabetes · Education only
            </p>
            <h1 className="text-2xl md:text-3xl font-semibold leading-tight">
              Understanding type 2 diabetes
            </h1>
            <p className="text-sm md:text-base text-gray-700">
              This page gives a simple overview of{" "}
              <span className="font-medium">type 2 diabetes</span> – the most
              common form of diabetes. It’s based on information from major
              diabetes organisations (American Diabetes Association, Diabetes UK
              and Diabetes Australia) and is for{" "}
              <span className="font-semibold">education only</span>. It does not
            ...
            <div className="flex flex-wrap gap-2 text-xs text-gray-600">
              ...
              <span className="inline-flex items-center gap-1 rounded-full bg-white/80 border border-gray-200 px-3 py-1">
                ℹ️ Educational content only
              </span>
            </div>
          </div>
        ...
        <div className="space-y-5 md:space-y-6">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-3">
              <div className="rounded-2xl border border-gray-100 bg-gray-50/80 p-4 space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  Use our provider list to look up doctors in different parts of
                  Lebanon.
                </p>
                <Link to="/providers" className="btn btn-primary text-sm">
                  Browse doctors in Lebanon
                </Link>
              </div>
              ...
              <div className="rounded-2xl border border-emerald-100 bg-emerald-50/80 p-4 space-y-2">
                ...
                <p className="text-sm text-gray-700">
                  If you would like to support people living with chronic
                  diseases in Lebanon, you can donate through the{" "}
                  <span className="font-medium">Chronic Care Center</span>.
                </p>
                <a
                  href="https://www.chroniccare.org.lb/support/donateonline"
                  target="_blank"
                  rel="noreferrer"
            ...
            <p className="text-[11px] text-gray-500 mt-3">
              This site is a student project. It does not replace professional
              medical advice, diagnosis or treatment. Always talk to a qualified
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-gray-200 mt-4">
          ...
          <div className="text-xs text-gray-500">
            Want to see how the model works? Go to{" "}
            <Link
              to="/history"
